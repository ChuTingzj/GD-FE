			...
			UnoCSS({
				...
				rules: [
					...
					[
						...
						(match) => ({" contain-intrinsic-size": match[1] + "px"}),
					],
					...
					[
						"grid-row-1-col-2-2/1",
						{display: "grid", "grid-template": "1fr/2fr 1fr", "column-gap": "1.3rem"},
					],
				],
				theme: {
					colors: {
				...
				shortcuts: {
					...
					"normal-bb": "border-b-solid border-b-2 border-gray-200 py-2",
					"normal-br": "border-r-solid border-r border-gray-400 pr-1",
					"detail-util-bar":
						"normal-theme w-48p h-48p rounded-full normal-flex text-lg cursor-pointer hover:text-antBlue",
					"detail-index-bar-articleInfo":
						"w-25p h-25p rounded-full bg-blue-200 text-blue-400 normal-flex",
				},
			}),
			react(),
		],
