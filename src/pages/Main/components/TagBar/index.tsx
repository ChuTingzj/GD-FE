...
export const TagBar: FC<TagBarProps> = (props) => {
  ...
  return (
    <div className='bg-white -ml-96 normal-flex gap-4 mt-4 p-3 sticky top-0 normal-transition dark:bg-dark dark:text-light'>
      <span style={{ left: '659px' }} ref={indicatorTagBar} className='bg-blue-5 transition-width-transform duration-400 ease-linear normal-indicator-bb pointer-events-none bg-opacity-75 absolute h-full w-8 top-0'></span>
      {
        tags.map((item) => (
